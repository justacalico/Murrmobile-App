...
REPO="justacalico/Murrmobile-App"
WORKFLOW="build.yml"
...
echo "Triggering GitHub workflow: $WORKFLOW @ $REF (build_all=$BUILD_ALL, merge_request_id=$MERGE_REQUEST_ID, merge_request_url=$MERGE_REQUEST_URL)"
